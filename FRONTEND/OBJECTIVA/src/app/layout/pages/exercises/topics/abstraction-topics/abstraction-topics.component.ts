...
export class AbstractionTopicsComponent {
  currentExercise: number = 0;  // Start with exercise 1
      ...
      constructor(private router: Router, private title: Title) {
        this.title.setTitle('Abstraction | Exercises');
        this.updateProgress();  
      }
      ...
      goToNextExercise() {
        if (this.currentExercise < this.totalExercises) {
          ...
          this.updateProgress();
          this.router.navigate([`/exercises-topics/exercise${this.currentExercise}-abstraction`]);
        }
      }
      ...
      reset() {
        ...
        this.updateProgress();
        this.router.navigate([`/abstraction/exercise1-abstraction`]);
      }
